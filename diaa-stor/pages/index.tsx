...
export const getServerSideProps: GetServerSideProps = async ({ locale, query }) => {
  ...
  try {
    const [
      ...
      (async () => {
        let q = supabase.from('products').select('id,name,slug,price,promo_price,images,category,is_new,stock,has_bundles,bundles:product_bundles(*),extra_unit_price,variants:product_variants(id,name,price,promo_price,extra_unit_price,stock,is_active)').eq('is_visible', true)
